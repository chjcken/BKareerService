    ...
    function ngGallery($document, $timeout, $q, $templateCache) {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                // show last image if screen is xs size
                scope.getThumbContainerClass = function(index) {

                    if ((index == scope.images.length - 1) && (index % 2 == 0)) {
                        return 'col-sm-12 col-md-4';
                    }

                    return 'hidden-xs col-sm-6 col-md-4';
                }
