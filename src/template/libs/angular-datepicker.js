...
(function withAngular(angular, navigator) {
  ...
  var A_DAY_IN_MILLISECONDS = 86400000
    ...
    , generateHtmlTemplate = function generateHtmlTemplate(prevButton, nextButton) {
      ...
      var toReturn = [
        '<div class="_720kb-datepicker-calendar {{datepickerClass}} {{datepickerID}}" ng-blur="hideCalendar()">',
        '</div>'
      ]
      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        var selector = attr.selector
          ...
          , onClickOnWindow = function onClickOnWindow() {
            if (!isMouseOn &&
              !isMouseOnInput && theCalendar) {
                //thisInput.trigger('focusout blur');
              $scope.hideCalendar();
            }
          }
          ...
          , showCalendar = function showCalendar() {
            ...
            if (theCalendar.classList || $scope.datepickerShow) {
        ...
        $scope.hideCalendar = function hideCalendar() {
          ...
          if (theCalendar.classList){
            ...
            //classHelper.remove(theCalendar, '_720kb-datepicker-forced-to-open');
        ...
        if (checkToggle()) {
          ...
          thisInput.on('focus', function onFocusAndClick() {
            isMouseOnInput = true;
            if (!isMouseOn &&
            !isMouseOnInput && theCalendar) {
        ...
        $scope.$on('$destroy', function unregisterListener() {
          ...
          $scope.$watch('datepickerShow', function(value) {
              if (value) {
                  thisInput.focus();
                  showCalendar();
              } else {
