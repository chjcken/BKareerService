...
define([
  ...
  function adminJobController(vm, NgTableParams, searchService, jobService, utils, $filter, $timeout) {
    vm.listJobs = [];
  ...
  adminJobController.$inject = ["$scope", "NgTableParams", "searchService", "jobService", "utils", "$filter", "$timeout"];
